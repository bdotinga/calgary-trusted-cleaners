-- fix-contacts-sort-order.sql
-- Corrects sort_order for all 20 contacts, matched by company name.
...
-- Verify all 20 updated correctly
SELECT sort_order, name, company
FROM public.contacts
ORDER BY sort_order;

SELECT COUNT(*) AS contacts_with_correct_order
FROM public.contacts
